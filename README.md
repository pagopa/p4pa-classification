...
| CLASSIFICATION_DB_CONNECTION_IDLE_TIMEOUT_MILLISECONDS   | PostgreSQL connection idle timeout (milliseconds)                                     | 600000                                                                                                                       |
| CLASSIFICATION_DB_CONNECTION_TIMEOUT_MILLISECONDS        | PostgreSQL connection timeout (milliseconds)                                          | 30000                                                                                                                        |
| CLASSIFICATION_DB_CONNECTION_KEEPALIVE_TIME_MILLISECONDS | PostgreSQL connection keepalive time (milliseconds)                                   | 120000                                                                                                                       |
| CLASSIFICATION_DB_CONNECTION_MAX_LIFETIME_MILLISECONDS   | PostgreSQL connection max lifetime (milliseconds)                                     | 1800000                                                                                                                      |
| CLASSIFICATION_DB_CONNECTION_MAX_POOL_SIZE               | PostgreSQL connection max pool size                                                   | 10                                                                                                                           |
| CLASSIFICATION_DB_CONNECTION_MIN_IDLE                    | PostgreSQL connection min idle                                                        | 10                                                                                                                           |
