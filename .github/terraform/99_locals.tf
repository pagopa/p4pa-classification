locals {
  ...
  common_tags = {
    ...
    Source      = "https://github.com/pagopa/p4pa-classification" # Repository URL
  ...
  github = {
    org        = "pagopa"
    repository = "p4pa-classification" # Repository Name
  }
  ...
  repo_env = var.env_short == "p" ? {
    SONARCLOUD_PROJECT_NAME = "p4pa-classification"
    SONARCLOUD_PROJECT_KEY  = "pagopa_p4pa-classification"
