...
@WebMvcTest(value = {ClassificationExceptionHandlerTest.TestController.class, ClassificationExceptionHandlerTest.TestCrudController.class})
@AutoConfigureMockMvc(addFilters = false)
@ContextConfiguration(classes = {
        ClassificationExceptionHandlerTest.TestController.class,
        ClassificationExceptionHandlerTest.TestCrudController.class,
        ClassificationExceptionHandler.class,
        JsonConfig.class})
class ClassificationExceptionHandlerTest {
    ...
    static class TestCrudController {
      @GetMapping(value = "/crud/classifications/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    private ResultActions performRequest(String data, MediaType accept) throws Exception {
        return performRequest(data, accept, objectMapper.writeValueAsString(ClassificationExceptionHandlerTest.BODY));
    }
