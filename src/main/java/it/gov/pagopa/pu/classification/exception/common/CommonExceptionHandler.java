...
import it.gov.pagopa.pu.classification.exception.transcoder.ExceptionMessageTranscoderService;
...
//region Spring Data Rest
  ...
  public ResponseEntity<ClassificationErrorDTO> handleResourceNotFoundException(ResourceNotFoundException ex, HttpServletRequest request) {
...
//region Spring Data
  ...
  public ResponseEntity<ClassificationErrorDTO> handleTransactionException(TransactionException ex, HttpServletRequest request) {
  ...
  public ResponseEntity<ClassificationErrorDTO> handleDataIntegrityViolationException(RuntimeException ex, HttpServletRequest request){
  ...
  public ResponseEntity<ClassificationErrorDTO> handleCannotAcquireLockException(CannotAcquireLockException ex, HttpServletRequest request) {
...
//endregion
  ...
  public ResponseEntity<ClassificationErrorDTO> handleConflictException(ConflictException ex, HttpServletRequest request) {
    return handleException(ex, request, HttpStatus.CONFLICT, ClassificationErrorDTO.CategoryEnum.CLASSIFICATION_CONFLICT);
  }

  @ExceptionHandler(ForbiddenException.class)
  public ResponseEntity<ClassificationErrorDTO> handleForbiddenException(ForbiddenException ex, HttpServletRequest request) {
    return handleException(ex, request, HttpStatus.FORBIDDEN, ClassificationErrorDTO.CategoryEnum.CLASSIFICATION_FORBIDDEN);
  }
  ...
  public ResponseEntity<ClassificationErrorDTO> handleNotAuthorizedException(Exception ex, HttpServletRequest request) {
    return handleException(ex, request, HttpStatus.UNAUTHORIZED, ClassificationErrorDTO.CategoryEnum.CLASSIFICATION_UNAUTHORIZED);
  }
  ...
  public ResponseEntity<ClassificationErrorDTO> handleNotFoundException(NotFoundException ex, HttpServletRequest request) {
    return handleException(ex, request, HttpStatus.NOT_FOUND, ClassificationErrorDTO.CategoryEnum.CLASSIFICATION_NOT_FOUND);
  }
  ...
  public ResponseEntity<ClassificationErrorDTO> handleAuthorizationDeniedException(Exception ex, HttpServletRequest request) {
    return handleException(ex, request, HttpStatus.FORBIDDEN, ClassificationErrorDTO.CategoryEnum.CLASSIFICATION_FORBIDDEN);
  }

  public static ResponseEntity<ClassificationErrorDTO> handleException(Exception ex, HttpServletRequest request, HttpStatus httpStatus, ClassificationErrorDTO.CategoryEnum errorEnum) {
    ...
    return ResponseEntity
      ...
      .body(new ClassificationErrorDTO(errorEnum, code, message, fields, Utilities.getTraceId()));
  }
