package it.gov.pagopa.pu.classification.connector.organization.config;

import it.gov.pagopa.pu.classification.config.rest.HttpClientErrorJsonBodyHandler;
import it.gov.pagopa.pu.classification.connector.organization.mapper.OrganizationErrorDTOMapper;
